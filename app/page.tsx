...
export default function Home() {
  return <>
    <section className="hero">
      <Image src={hero} alt="The Collaborative Bakersfield Jiu Jitsu team on the mats" fill priority sizes="100vw" />
      ...
      <p className="hero-side">The Collaborative Bakersfield<br />Gracie Allegiance Jiu Jitsu</p>
    </section>
    <Announcements />
    <section className="intro section"><div className="intro-photo"><Image src={team} alt="The Collaborative athletes" fill sizes="(max-width: 760px) 100vw, 43vw" /></div><div><p className="eyebrow">More than a gym</p><h2>Come as you are.<br /><em>Grow together.</em></h2><p>A family-built academy where confidence, discipline, and lasting connections are made on and off the mats.</p><Link className="text-link" href="/about">Meet The Collaborative <span>→</span></Link></div></section>
